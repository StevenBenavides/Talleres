...
2. ¿Qué se puede concluir sobre la relación entre el peso y la tensión sistólica basándose en el coeficiente de correlación?
     ...
     Dado que el valor del coeficiente de correlación de Pearson (𝑟) es aproximadamente 0.9911, lo que está cerca de 1, podemos concluir que existe una correlación           positiva muy fuerte entre el peso y la tensión sistólica en estos datos. La relación entre las 2 mediciones es que mientras una variable aumenta la otra también lo 
     hace y de manera lineal
...
6. ¿Qué salida se esperaría si el coeficiente de correlación es calculado con datos donde la tensión sistólica aumenta a medida que el peso disminuye?
